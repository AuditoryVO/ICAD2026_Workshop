...
Please explore the Documentation folder and read carefully the SoniAladin-Installation_guidelines.pdf file. Additional Quick Installation guidelines can be found both for Mac and Windows opeating systems.
